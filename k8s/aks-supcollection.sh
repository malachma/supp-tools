...
declare -A commands=( 
  ...
  ['Describe pods']='kubectl describe pods --all-namespaces > pods-describe.txt.$OUTPUT 2<&1'
  ['Describe services']='kubectl describe services > services-describe.txt.$OUTPUT 2<&1'
